        ...
        for(let participant of chat.participants) {
            ...
            if(contact.isMe){
                ...
                if(participant.isAdmin||participant.isSuperAdmin){
                    ...
                    await chat.sendMessage("_Trina isn't the admin of this group_");
                    break;
                }
            }
...
module.exports = {
    ...
    description: 'remove someone from the group(ONLY IF BEN ALLOWS YOU TO)', // short description of what this command does
