...
const execute = async (client,msg/*,args*/) => {
    ...
    var list_section=[{title:'List Of Games',rows:[{id:'customId', title:'!NumbersGame', description: 'Trina will pick a number between 1 to 100 and you have to guess it!'},{title:'!RiddlesGame', description: 'Trina will send a riddle and you have to solve it!'},{title:'Next Game', description: 'If you have an idea for the next game that can be created in Whatsapp\nLet me know'}]}];
