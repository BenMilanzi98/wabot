...
client.on("message_create", async (msg) => {
  ...
  try {
    if (config.pmpermit_enabled == "true") {
      ...
      if (
        ...
        !otherChat.isMe &&
        !msg.body.startsWith("!") &&
        !msg.body.endsWith("_Tech Transformation_")
      ) {
  ...
  // if(!msg.body.startsWith("!")){
  if (msg.body.includes("@") && !msg.body.startsWith("*MESSAGES") && !msg.body.includes("_This Message is Automated by Trina Because of !all command_")) {
